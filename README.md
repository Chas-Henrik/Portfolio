...
The design is a 'mobile first' responsive design that also support Tablet & Desktops. Breakpoints have been set at 815px for Mobile and 1024px for Desktop's, and everything between 815px and 1024px is intended for Tablets and small Desktops. The 815px breakpoint has been selected so that one 'full screen project card' turns directly into two cards when passing the breakpoint, and deviates slightly from the 'normal' 768px Mobile breakpoint. An additional content driven breakpoint has been set at 1350px to prevent navigation bar overflow and 'profile picture bouncing' when resizing the Web Browser on a Desktop.  
